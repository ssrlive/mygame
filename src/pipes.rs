        ...
        world
            ...
            .with_children(|builder| {
                ...
                builder
                    .spawn((
                        sprite,
                        Transform::from_xyz(0.0, (pipe_size.y / 2.0 + gap_size / 2.0) + position as f32, 1.0),
                    ))
                    .insert(Collider::capsule(Vec2::new(0.0, -200.0), Vec2::new(0.0, pipe_size.y), 100.0))
            ...
            .insert(Pipe { noise: center_of_opening });
    }
}
