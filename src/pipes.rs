...
fn spawn_pipe_system(
    ...
    let mut pipe_delta = rng.random_range(pipe_settings.min_pipe_distance..pipe_settings.max_pipe_distance);
    ...
    commands.spawn((
        sprite.clone(),
        Transform::from_translation(Vec3::new(x_pos, -pipe_offset_y + new_center_pos - pipe_delta, 3.0)),
