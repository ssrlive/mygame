...
pub(crate) const BOARD_X: isize = 10;
pub(crate) const BOARD_Y: isize = 23; // board is 10x20
pub(crate) const BOARD_X_Y: usize = 230; // we create 230 for more space for rotate brick.

pub(crate) const BOARD_Y_VALIDE: isize = 20; // checking for game over
...
pub static BRICKS_DICT: std::sync::LazyLock<Vec<Vec<Brick>>> = std::sync::LazyLock::new(|| {
    vec![
        //O:
        vec![Brick {
            dots: [Dot(1, 1), Dot(1, 2), Dot(2, 1), Dot(2, 2)],
        }],
        //I:
        vec![
            Brick {
            ...
            Brick {
                dots: [Dot(2, 0), Dot(2, 1), Dot(2, 2), Dot(2, 3)],
            },
        ],
        //J:
        vec![
            Brick {
                dots: [Dot(0, 1), Dot(1, 1), Dot(2, 1), Dot(2, 0)],
            },
            Brick {
                dots: [Dot(1, 0), Dot(1, 1), Dot(1, 2), Dot(0, 0)],
            },
            Brick {
                dots: [Dot(0, 1), Dot(1, 1), Dot(2, 1), Dot(0, 2)],
            },
            Brick {
                dots: [Dot(1, 0), Dot(1, 1), Dot(1, 2), Dot(2, 2)],
            },
        ],
        //L:
        vec![
            Brick {
                dots: [Dot(0, 1), Dot(1, 1), Dot(2, 1), Dot(0, 0)],
            },
            Brick {
                dots: [Dot(1, 0), Dot(1, 1), Dot(1, 2), Dot(0, 2)],
            },
            Brick {
                dots: [Dot(0, 1), Dot(1, 1), Dot(2, 1), Dot(2, 2)],
            },
            Brick {
                dots: [Dot(1, 0), Dot(1, 1), Dot(1, 2), Dot(2, 0)],
            },
        ],
        //S:
        vec![
            Brick {
                dots: [Dot(0, 0), Dot(1, 0), Dot(1, 1), Dot(2, 1)],
            },
            Brick {
                dots: [Dot(1, 2), Dot(1, 1), Dot(2, 1), Dot(2, 0)],
            },
        ],
        //Z:
        vec![
            Brick {
                dots: [Dot(0, 1), Dot(1, 1), Dot(1, 0), Dot(2, 0)],
            },
            Brick {
                dots: [Dot(2, 2), Dot(2, 1), Dot(1, 1), Dot(1, 0)],
            },
        ],
        //T:
        vec![
            Brick {
                dots: [Dot(0, 1), Dot(1, 1), Dot(2, 1), Dot(1, 0)],
            },
            Brick {
                dots: [Dot(1, 0), Dot(1, 1), Dot(1, 2), Dot(0, 1)],
            },
            Brick {
                dots: [Dot(0, 1), Dot(1, 1), Dot(2, 1), Dot(1, 2)],
            },
            Brick {
                dots: [Dot(1, 0), Dot(1, 1), Dot(1, 2), Dot(2, 1)],
            },
        ],
    ]
});
